      ...
      <nav className="fixed top-0 left-0 w-full px-6 md:px-12 py-6 flex justify-between items-center z-[100] backdrop-blur-xl bg-background/50 border-b border-white/5">
         ...
         <div className="flex items-center gap-4">
            <button 
              ...
              className="px-5 h-10 rounded-full bg-white/5 border border-white/10 flex items-center gap-3 text-[10px] font-black uppercase tracking-widest hover:bg-white/10 transition-all"
            >
