...
export const users = mysqlTable("users", {
  ...
  role: mysqlEnum("role", ["user", "admin", "agent", "team_member"])
    .default("user")
    .notNull(),
...
export const workspaces = mysqlTable("workspaces", {
  ...
  plan: mysqlEnum("plan", ["starter", "pro", "agency"])
    .default("starter")
    .notNull(),
...
export const brandKits = mysqlTable("brandKits", {
  ...
  telegramChannel: varchar("telegramChannel", { length: 100 }),
  agentPortrait: varchar("agentPortrait", { length: 500 }),
  tagline: varchar("tagline", { length: 255 }),
  targetAreas: json("targetAreas"),
  languagePreference: mysqlEnum("languagePreference", [
    "amharic",
    "english",
    "both",
  ]).default("both"),
...
export const supplierListings = mysqlTable("supplierListings", {
  ...
  status: mysqlEnum("status", ["new", "reviewed", "imported"])
    .default("new")
    .notNull(),
